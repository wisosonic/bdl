        ...
        <div class="container d-flex">
            ...
            <div data-aos="fade-up" data-aos-delay="100" class="card" style="width: 25rem; margin-right: 10rem">
                <div class="card-body my-5 mx-5">
                    ...
                    <div data-aos="fade-up" data-aos-delay="300"  class="form-check form-check-inline mb-4">
                    ...
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="300">
                        <a href="#" onclick="login()" class="btn-get-started me-2">Login</a>
                        <button type="button" onclick="window.location.replace('/register')" class="btn btn-outline-dark me-2">Sign up</button>
