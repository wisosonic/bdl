    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-md-12" style="text-align: right;">
            <button onclick="backToTable({{$event->id}})" type="button" class="btn btn-primary mybutton">Back</button>
          </div>
          <div class="col-md-12">
          ...
          <div class="col-md-12">
          <button onclick="updateRegistration({{$event->id}})" type="button" class="btn btn-primary mybutton">Save</button>
          </div>
        </div>
      </div>
    </div>
