<section id="contact" class="section-bg wow fadeInUp">
    ...
    <div class="container">
        ...
        <div class="section-header">
          <h2>Contact Us</h2>
          <p>
            Have questions about the event or need to report an issue with this page ? 
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>Hariri Hall - Beirut Arab University - Beirut</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+9613616926"> Dr Nizar Kadi: 03 616 926</a></p>
              <p><a href="tel:+9613809350"> Dr Samer Hout: 03 809 350</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:info@example.com">info@bdl-lebanon.com</a></p>
            </div>
          </div>
        ...
        <div class="form">
          ...
          <form action="" method="post" role="form" class="contactForm">
            ...
            <div class="text-center"><button type="submit" onclick="submitMessage(); return false;">Send Message</button></div>
          </form>
        </div>
