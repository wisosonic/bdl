<footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-10 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
              Beirut Arab University - Hariri Building - Jamil Rawas Hall <br>
              <strong>Phone:</strong> Dr Aya Al Ghali: 71 44 61 62 - Dr Yara Chidiac: 76 95 28 29<br>
              <strong>Email:</strong> info@beirut-dentists-league.com<br>
            </p>

            <div class="social-links">
              <a href="#" class="twitter"><i class="fa fa-twitter"></i></a>
              <a href="https://www.facebook.com/profile.php?id=100063502963109" class="facebook"><i class="fa fa-facebook"></i></a>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Beirut Dentist's League</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
